...
const blogPosts = [
  ...
  {
    title: "10 Lessons I Learned from 1.5 Years of Being a Software Engineer",
    excerpt:
      "Reflecting on my 1.5-year journey as a software engineer, here are 10 valuable lessons I've learned that can help you navigate your own career in tech.",
