...
const apps = [
  ...
  },
  {
    ...
    link: "https://github.com/mahdijafaridev/VoiceType",
    screenshot: "/apps.png",
    details:
      "A voice-first typing tool that helps you convert speech into text quickly. It is designed to speed up note-taking, writing, and daily workflows with a lightweight interface.",
    color: "#4b7f9c",
  },
];
